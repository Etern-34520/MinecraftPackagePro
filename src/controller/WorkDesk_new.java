...
public class WorkDesk_new extends GridPane {
    @FXML
    SplitPane topPane;
    @FXML
    SplitPane leftPane;
    ...
    public WorkDesk_new(){
        URL url;
        try {
            url = new URL("file:"+new File("bin/controller/resource/WorkDesk_new.fxml").getPath());
    ...
    public void add(Node node, Way way, String name, Double width, Double height) {
        HBox buttonBar = null;
